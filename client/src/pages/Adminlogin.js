...
import { adminsentOtpFunction } from "../services/Apis";
...
const Adminlogin = () => {
    ...
    const sendOtp = async (e) => {
        ...
        if (email === "") {
            ...
            const response = await adminsentOtpFunction(data);
            ...
            <section>
                <div className="form_data">
                    <div className="form_heading">
                        <h1>Welcome to PetWale365, Admin Log In</h1>
                    ...
                    <form>
                        ...
                        <p>Don't have an account? <NavLink to="/adminregister">Sign up</NavLink></p>
                    </form>
                </div>
                <ToastContainer />
            </section>
