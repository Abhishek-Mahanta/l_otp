...
import { docsentOtpFunction } from "../services/Apis";
...
const Doclogin = () => {
    ...
    const sendOtp = async (e) => {
        ...
        if (email === "") {
            ...
            const response = await docsentOtpFunction(data);

            if (response?.status === 200) {
                // setSpiner(spiner);
                navigate("/Docotp", { state: email })
            } else {
            ...
            <section>
                <div className="form_data">
                    <div className="form_heading">
                        <h1>Welcome to PetWale365, Doctor Log In</h1>
                    ...
                    <form>
                        ...
                        <p>Don't have an account? <NavLink to="/doctorreg">Sign up</NavLink></p>
                    </form>
                </div>
                <ToastContainer />
            </section>
